...
kubectl port-forward svc/comments-nodeport-prod -n production 3006:8002 --address='0.0.0.0' &
echo "Comments: http://172.28.198.57:3006/"

kubectl port-forward svc/event-bus-nodeport-prod -n production 3007:8005 --address='0.0.0.0' &
echo "Event-bus: http://172.28.198.57:3007/events"

kubectl port-forward svc/query-nodeport-prod -n production 3008:8003 --address='0.0.0.0' &
echo "Query: http://172.28.198.57:3008/posts"

kubectl port-forward svc/post-nodeport-prod -n production 3009:8001 --address='0.0.0.0' &
echo "Posts: http://172.28.198.57:3009/post"

kubectl port-forward svc/moderation-nodeport-prod -n production 3010:8004 --address='0.0.0.0' &
